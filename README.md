...
# 🍿[Google-Drive-Directory-Index](https://github.com/minhquan16jp/goindex-theme-acrou)
...
[go2index/index.js](https://github.com/minhquan16jp/goindex-theme-acrou/blob/main/go2index/index.js) is the content of the Workers script.  
...
🛠 Quick Development: [here/](https://github.com/minhquan16jp/goindex-theme-acrou/edit/main/README.md#quick-deployment)
...
5. Download `index.js` in https://github.com/minhquan16jp/goindex-theme-acrou/tree/master/go2index and replace `client_id`,`client_secret`,`refresh_token` for what you just got.
...
<a href="https://star-history.com/#minhquan16jp/goindex-theme-acrou&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=minhquan16jp/goindex-theme-acrou&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=minhquan16jp/goindex-theme-acrou&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=minhquan16jp/goindex-theme-acrou&type=Date" />
 </picture>
</a>
